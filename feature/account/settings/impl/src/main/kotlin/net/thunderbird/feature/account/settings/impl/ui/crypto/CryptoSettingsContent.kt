...
@Composable
internal fun CryptoSettingsContent(
    ...
    builder: CryptoSettingsContract.SettingsBuilder,
    ...
    provider.SettingView(
        title = stringResource(R.string.account_settings_crypto),
        subtitle = state.subtitle,
        settings = settings,
        onSettingValueChange = { setting -> handleSettingChange(setting, onEvent) },
        onBack = { onEvent(CryptoSettingsContract.Event.OnBackPressed) },
        modifier = modifier,
        actions = {
