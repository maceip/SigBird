...
@Composable
internal fun FolderSettingsContent(
    ...
    builder: FolderSettingsContract.SettingsBuilder,
    ...
    provider.SettingView(
        title = stringResource(R.string.account_settings_folders),
        subtitle = state.subtitle,
        settings = settings,
        onSettingValueChange = { setting -> handleSettingChange(setting, onEvent) },
        onBack = { onEvent(FolderSettingsContract.Event.OnBackPressed) },
        modifier = modifier,
        actions = {
